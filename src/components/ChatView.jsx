...
const options = ['MegAI-Text', 'MegAI-Image'];
const gptModel = ['gpt-3.5-turbo', 'MegAI-Enterprise'];
const template = [
  {
    title: 'Plan a trip',
    ...
    <main className='relative flex flex-col h-screen p-1 overflow-hidden dark:bg-light-grey'>
      <div className='mx-auto my-4 tabs tabs-boxed w-fit'>
        <a
          ...
          <span
  onClick={() => {
    alert("Your Access Token doesn't quite make the cut for Enterprise Edition eligibility. 🚫 Keep striving for that upgraded status!"); // You can replace this with your custom popup logic
  }}
